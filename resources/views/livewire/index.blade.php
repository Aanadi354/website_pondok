        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <h1 class="mb-4">
                ...
                <span class="accent-text">Royan Al Manshurien</span>
              </h1>
          ...
          <div class="col-lg-6">
            <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
              <img src="assets/img/home1.png" alt="Hero Image" class="img-fluid" width="500">
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="assets/img/santri.png" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="assets/img/asad.png" alt="Team Discussion" class="img-fluid small-image rounded-4">
              </div>
          ...
          <div class="tab-pane fade active show" id="features-tab-1">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="assets/img/home1.png" alt="" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="phone-mockup text-center">
              <img src="assets/img/orang.png" alt="Phone Mockup" class="img-fluid">
            </div>
